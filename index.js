...
let arr1 = ["Company A", "Engineering", 96000];
let arr2 = ["Company B", "Marketing", 65000];
let arr3 = ["Company C", "Legal", 57000];
let arr4 = ["Company D", "Finance", 105000];

let multiTable = []
console.log(multiTable.push(arr1, arr2, arr3, arr4));
console.log(multiTable);

console.log(multiTable[0][2]);
console.log(multiTable[1][2]);
console.log(multiTable[2][2]);
console.log(multiTable[3][2]);
